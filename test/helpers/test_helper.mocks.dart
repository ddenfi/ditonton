...
import 'package:ditonton/data/models/show_table.dart' as _i17;
...
class MockDatabaseHelper extends _i1.Mock implements _i15.DatabaseHelper {
  ...
  @override
  _i6.Future<int> insertWatchlist(_i17.ShowTable? show) => (super.noSuchMethod(
        Invocation.method(
          #insertWatchlist,
          [show],
        ),
  ...
  @override
  _i6.Future<int> removeWatchlist(_i17.ShowTable? show) => (super.noSuchMethod(
        Invocation.method(
          #removeWatchlist,
          [show],
        ),
  ...
  @override
  _i6.Future<Map<String, dynamic>?> getShowById(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getShowById,
          [id],
        ),
  ...
  @override
  _i6.Future<List<Map<String, dynamic>>> getWatchlistShows() =>
      (super.noSuchMethod(
        Invocation.method(
          #getWatchlistShows,
          [],
